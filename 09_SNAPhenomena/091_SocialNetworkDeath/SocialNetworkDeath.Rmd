...
```{r echo=F, fig.width=8, fig.height=3, message=FALSE, cache=T}
library(gtrendsR)
library(ggplot2)
library(dplyr)
...
```{r echo=F, fig.width=8, fig.height=3, cache=T}
...
Data scientists at Facebook [replied to the Arxiv paper](https://www.facebook.com/notes/mike-develin/debunking-princeton/10151947421191849/) [PDF](princeton-facebook.pdf) showing the problem with measuring social network use levels using Google Trends data. Applying the same methodology, Facebook researchers reached the conclusion that Princeton would lose 80% of its students by 2021:
